        ...
        <div className="text-sm font-medium text-center sm:flex sm:justify-end lg:justify-start">
            <ul className="flex">
                <li className={`${mode() === "dark" ? " bg-primarry-1" : "bg-gray-200"} flex items-center`}>
                    <a href="#" className="inline-block px-8 py-5 my-[-8px] border-b-2 border-transparent rounded-t-lg text-gray-400 ">
                ...
                <ul className="flex flex-1 whitespace-nowrap ">
                    ...
                    <li className={`${mode() === "dark" ? " bg-primarry-1" : "bg-gray-200"} flex items-center`}>
                        <Link href="/deck-explorer/system-settings" activeClass="border-b-2 border-gray-300 text-white" className="inline-block px-8 no-underline py-5 my-[-8px]  rounded-t-lg text-gray-400 hover:text-white ">
                            SYSTEM SETTINGS
                        </Link>
                    </li>
