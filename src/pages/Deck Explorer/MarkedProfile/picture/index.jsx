...
const Picture = () => {
    ...
    return <LayoutMarkedProfile title={'PICTURE'}>
        <div className="flex-1 flex flex-col min-h-[600px] space-y-3">
            <div className="flex justify-between w-full">
                ...
                <Link href={`${currentHref()}/add`}>
                    <Button variant="contained" color="secondary" startIcon={<AddAPhoto></AddAPhoto>} >ADD YOUR PICTURE</Button>
                </Link>
            </div>
            <CardFrame title={"PICTURE"} className="relative flex flex-1 flex-col group-item">
