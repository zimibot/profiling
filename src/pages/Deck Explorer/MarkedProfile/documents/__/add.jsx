import { Add, ArrowLeft, Edit, FileUpload, Save, Upload } from "@suid/icons-material"
                    ...
                    <div className="col-span-5 relative border-r-2 border-[#333]">
                        <div className="h-full absolute w-full overflow-hidden flex items-center justify-center p-4 group">
                            ...
                            <div className="p-5 absolute bottom-0 left-0 w-full  justify-between flex items-center">
                                ...
                                <div>
                                    <Button variant="contained" color="secondary" startIcon={<Upload></Upload>}>UPLOAD DOCUMENT</Button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="col-span-2 p-4 flex-1 flex flex-col justify-between">
                        <div className="space-y-3">
                            ...
                            <div>
                                ...
                                <textarea className="bg-primarry-2 p-2 w-full outline-none min-h-[200px] text-[20px]" spellCheck={false} placeholder="INPUT DESCRIPTION" />
                            </div>
                        </div>
